    ...
    return (
        <>
            ...
            <div className="flex h-full w-lvw overflow-y-hidden overflow-x-auto whitespace-nowrap">
                <ArrowLeft
                    className="hidden lg:block absolute top-1/2 left-0 ml-2 transform -translate-y-1/2 cursor-pointer text-white"
                    onClick={() => {
                        moveLeft();
                    }}
                />
                {img_links.length > 0 && (
                    <div
                        className="h-full w-[100vw] flex-shrink-0 overflow-hidden"
                    ...
                    >
                        <Image
                            ...
                            priority={true}
                            src={img_links[currentImageIndex]}
                ...
                <ArrowRight
                    className="hidden lg:block absolute top-1/2 right-0 mr-2 transform -translate-y-1/2 cursor-pointer text-white"
                    onClick={() => {
                        moveRight();
                    }}
                />
